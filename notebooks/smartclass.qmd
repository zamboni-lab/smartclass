...
This queries Wikidata for chemical classes defined with SMARTS and exports the
results.
...
```{bash}
#| label: Classification single SMILES
...
```{bash}
#| label: Classification single SMILES all classes
...
```{bash}
#| label: Classification file of SMILES
